...
// 导入视频 URL
const videoUrls = [
  "/us/assets/video/home/about/1.mp4",
  "/us/assets/video/home/about/2.mp4",
...
const EmblaCarousel: React.FC<PropType> = (
  props: PropsWithChildren<PropType>
) => {
  const { options } = props
  ...
  return (
    <div className="embla4 w-screen h-[80vh] relative">
      ...
      <div className="absolute bottom-10 right-5">
        <button
          className="embla__play shadow-md hover:shadow-lg embla__play inline-flex items-center justify-center text-white font-semibold text-lg px-6 opacity-0 transition-opacity duration-300 hover:opacity-100 hover:bg-gray-200/50 rounded-full cursor-pointer"
